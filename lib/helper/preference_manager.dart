...
class PreferencesManager {
  ...
  DateTime? getDateTime(final String key) => DateTime.tryParse(_prefs.getString(key) ?? '');
  ...
  Future<bool> setDouble(final String key, final double value) => _prefs.setDouble(key, value);

  Future<bool> setInt(final String key, final int value) => _prefs.setInt(key, value);

  Future<bool> setString(final String key, final String value) => _prefs.setString(key, value);

  Future<bool> setStringList(final String key, final List<String> value) => _prefs.setStringList(key, value);

  Future<bool> setDateTime(final String key, final DateTime value) => _prefs.setString(key, value.toIso8601String());
}
