...
class BasicIcon extends ConsumerWidget {
  ...
  Widget build(final BuildContext context, final WidgetRef ref) {
    ...
    if (raw["Disable"] == true || !raw.containsKey("CodePoint")) {
  ...
  Widget build(final BuildContext context, final WidgetRef ref) {
    ...
    final onPressed = (() async {
      if (tempSettingsDialog) {
        ...
        await Device.postMessage(id, editInfo, ref.read(apiProvider), null);
      }
    });
    if (raisedButton) {
...
class BasicSlider extends HookConsumerWidget {
  ...
  Widget build(final BuildContext context, final WidgetRef ref) {
    ...
    final double sliderVal = valueModel.currentValue is double
